...
- Api endpoint descriptions:
    * link:https://drive.google.com/uc?confirm=t&export=download&id=1HJ-W2rl5kPOuQO5wQgYwA4OR0391ts2-[CSV format]
    * link:https://drive.google.com/uc?confirm=t&export=download&id=16y1pik1X6dUZmCwYhmk7zujqcOQWlg3y[Pickle Format (pandas)]
